    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{route('rebukes.import')}}">Імпорт</a></li>
            </ol>
        </section>
        ...
        <section class="content">
            <!-- Default box -->
            <form action="{{route('rebukes.import')}}" method="post" class="import-form"
                    ...
                    <div class="box-body d-flex justify-content-center">
                        <div class="col-md-6 d-flex flex-column align-items-center">
                            <div class="form-group w-100 d-flex flex-column align-items-center">
                                ...
                                <a href="{{route('rebukes.example')}}" download="" class="d-block mt-3">
                                    Завантажити зразок
                                </a>
                            </div>
