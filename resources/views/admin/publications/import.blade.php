    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{route('publications.import')}}">Імпорт</a></li>
            </ol>
        </section>
        ...
        <section class="content">
            <!-- Default box -->
            <form action="{{route('publications.import')}}" method="post" class="import-form"
                    ...
                    <div class="box-body d-flex justify-content-center">
                        <div class="col-md-6 d-flex flex-column align-items-center">
                            <div class="form-group w-100 d-flex flex-column align-items-center">
                                ...
                                <a href="{{route('publications.example')}}" download="" class="d-block mt-3">
                                    Завантажити зразок
                                </a>
                            </div>
