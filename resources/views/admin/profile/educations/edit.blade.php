    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{route('profile.show')}}">Мої освіти</a></li>
                <li><a href="{{route('profile.educations.edit', $education->id)}}">Редагувати</a></li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <!-- Default box -->
            <form action="{{route('profile.educations.update', $education->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
