    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{route('profile.show')}}">Публікації</a></li>
                <li><a href="{{route('profile.edit', $publication->id)}}">Редагувати</a></li>
            </ol>
        </section>
        ...
        <section class="content">
            <!-- Default box -->
            <form action="{{route('profile.publications.update', $publication->id)}}" method="post">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control pull-right calendar"
                                       value="{{to_locale_date($publication->date_of_publication)}}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="authors" name="authors[]"
                                        multiple="multiple"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="another_authors"
