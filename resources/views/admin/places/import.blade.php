...
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <h1>
                Імпорт місць стажувань
            </h1>

            <ol class="breadcrumb">
                <li><a href="/admin"><i class="fa fa-dashboard"></i>Головна</a></li>
                <li><a href="{{route('places.index')}}">Місця стажування</a></li>
                <li><a href="{{route('places.import')}}">Імпорт</a></li>
            </ol>
        </section>
        ...
        <section class="content">
            <!-- Default box -->
            <form action="{{route('places.import')}}" method="post" class="import-form"
                    ...
                    <div class="box-body d-flex justify-content-center">
                        <div class="col-md-6 d-flex flex-column align-items-center">
                            <div class="form-group w-100 d-flex flex-column align-items-center">
                                ...
                                <a href="{{route('places.example')}}" download="" class="d-block mt-3">
                                    Завантажити зразок
                                </a>
                            </div>
